...
<body class="font-sans antialiased text-gray-900">
    ...
    <div class="flex flex-col items-center min-h-screen pt-6 content-container sm:justify-center sm:pt-0">
        <div>
        ...
        <div class="w-full px-6 py-8 mt-6 overflow-hidden shadow-md sm:max-w-md glass-panel sm:rounded-lg">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="flex items-center justify-end mt-4">
                    <a class="text-sm text-gray-400 underline rounded-md hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        href="{{ route('login') }}">
    ...
    <script>
        // Inisialisasi particles.js (konfigurasi yang sama)
